...
function showIntegrationInfo(name){
  const text={
    ...
    'Signering':'Signering V1 er en intern sporingsflyt. Opprett signeringsforespørsel, velg mottakere, frist og status. Senere kan BankID, Signicat eller Penneo kobles på for ekte digital signatur.',
